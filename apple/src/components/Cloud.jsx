...
const Cloud = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const opacity = window.scrollY > 50 ? 0.95 : 1; // Adjust opacity based on scroll
  ...
  return (
    <div className="icloud-page">
      ...
      <main className="content">
        ...
        <h1 className="title">iCloud</h1>
        <button className="login-button">로그인</button>
        <h2 className="subtitle">모든 사진, 파일, 메모, 이메일 등<br/>에 사용할 수 있습니다.</h2>

        <div className="card-container">
          <div className="card">
            <img src="https://www.icloud.com/system/icloud.com/2426Hotfix47/06b68855764eb0e23f269ed4ef7935f0.png" alt="icons" className="card-icon" />
            <h3>웹에서 iPhone에 있는 데이터와 앱에<br/> 쉽게 액세스</h3>
            <p>기기에 있는 개인 정보를 안전하게 최신 상태로 유지하고 어디서든 이용하려면 iCloud가 필수입니다. 모든 브라우저에서 iCloud.com을 통해 사진, 파일 등에 액세스할 수 있습니다. 변경 사항이 iPhone 및 다른 기기와 동기화되므로 항상 최신 상태를 유지할 수 있습니다.</p>
          </div>
          <div className="card">
            <img src="https://www.icloud.com/system/icloud.com/2426Hotfix47/7cb9ecdad2b384754de394732519f658.png" alt="iCloud+" className="card-icon2" />
            <h3>더 많은 저장 공간과 개인정보 보호를 위한 추가 기능</h3>
            <p>더 많은 저장 공간과 iCloud 비공개 릴레이, 나의 이메일 가리기 및 HomeKit 보안 비디오 등의 추가 기능을 이용하려면 iCloud+로 업그레이드하십시오. 가족과 구독을 공유할 수도 있습니다. <a href="https://apple.com/icloud" target="_blank" rel="noopener noreferrer" style={{marginLeft:"-1px"}}>apple.com/icloud</a>에서 자세히 알아보십시오.</p>
          </div>
        </div>
      </main>
      ...
      <div className="copyright" style={{backgroundColor:'#fff'}}>
                    <p className="p2" style={{backgroundColor:'#fff'}}> 시스템 상태 | 개인정보 처리방침 | 이용 약관</p>
                    <p style={{marginLeft:'30%', backgroundColor:'#fff'}}>Copyright © 2024 Apple Inc. 모든 권리 보유.</p>
      </div>
      </footer>
    </div>
  );
